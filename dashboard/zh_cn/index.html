...
<html lang="zh_cn">
  ...
  <body class="zh_cn zh_cn_index index">
    <div id="fb-root"></div>
    ...
    <header class="header contain-to-grid">
      <nav class="top-bar" data-topbar>
        ...
        <section class="top-bar-section">
          <!-- Left Nav Section -->
          <ul class="left">
              <li class="item "><a href="/dashboard/zh_cn/faq.html">常见问题</a></li>
...
<div class="row">
  <div class="large-12 columns">
    <p>
      ...
      You can find more info in the <a href="/dashboard/zh_cn/faq.html">常见问题</a> section or check the <a href="/dashboard/zh_cn/howto.html">HOW-TO Guides</a> for getting started with PHP applications.
    </p>
    <p>
...
<div class="row">
  <div class="large-12 columns">
    <p>
      XAMPP已经存在了大约十多年——在它背后有一个巨大的社区。你可以通过加入我们的<a href="https://community.apachefriends.org">论坛</a>，在<a href="https://www.facebook.com/we.are.xampp">Facebook</a>上喜欢我们，在<a href="https://twitter.com/apachefriends">Twitter</a>上关注我们的成就。
    </p>
  </div>
</div>
