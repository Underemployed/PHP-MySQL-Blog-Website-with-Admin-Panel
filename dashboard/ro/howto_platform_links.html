...
<html lang="ro">
  ...
  <body class="ro ro_howto_platform_links">
    <div id="fb-root"></div>
    ...
    <header class="header contain-to-grid">
      <nav class="top-bar" data-topbar>
        ...
        <section class="top-bar-section">
          <!-- Left Nav Section -->
          <ul class="left">
              <li class="item "><a href="/dashboard/ro/faq.html">Întrebări frecvente - FAQs</a></li>
              <li class="item active"><a href="/dashboard/ro/howto.html">HOW-TO Guides</a></li>
